"""Retired Paper IX diagnostics: state mixing, oscillation, and cross-domain rates.
...
This script preserves hard-coded historical summaries from Paper IX v1. It is
not current evidence for Paper IX v2 and must not be used as a computational
certificate.
"""
