"""Retired Paper IX plateau postprocess/compute script for QT perturbations.
...
This legacy calculation uses the retired generator-weight fragmentation
semantics. It is retained as provenance only and is not current evidence for
Paper IX v2.
"""
