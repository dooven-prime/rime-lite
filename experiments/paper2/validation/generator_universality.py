...
Tests whether the core structural phenomena (sparse hub pattern, V2/3 freezing,
...
Run: python experiments/paper2/validation/generator_universality.py
"""
...
FIG_DIR = os.path.join(
    os.path.dirname(__file__), '..', '..', '..', 'figures', 'paper2', 'diagnostics'
)
...
def analyze_generator_set(name, cfg):
    ...
    # 2. Transport tensor — check the sparse hub pattern
...
def main():
    ...
    print("Tests structural stability of the sparse hub pattern, freezing, Lie incompleteness")
    print("=" * 90)
