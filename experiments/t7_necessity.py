...
A_S acts within each isotypic component as A_S^tau ⊗ I_{m_tau}
...
N1 STATUS (Shared Irrep Necessity):
  PROVED for abelian groups.
  PROVED for isotypic blocks.
  STRONG EVIDENCE for general case (A_S^tau ⊗ I_m mechanism).

Uses rime.spectral_utils for all utilities.
SCRIPT: test/canonical/_exp_abelian_t7.py
""")
