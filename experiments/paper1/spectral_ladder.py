"""Spectral Ladder — 6-layer rational spectrum of A₁₈.

Computationally verified:
  - Spec(A₁₈) = {1 − k/9 | k ∈ {0, 1, 2, 3, 4, 6}}
  - Multiplicities: [20, 2, 39, 26, 106, 35]
  - k=5 genuinely absent
...
print(f"  Arithmetic closure: k-set = {{0,1,2,3,4,6}}")
print(f"  Forbidden: k in {{5,7,8,9}} (k=1 now present post-ρ-fix)")
