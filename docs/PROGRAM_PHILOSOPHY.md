...
but small enough that the full structure can be audited.
...
generator-set deformation
  ->
general spectral wall theory
```

Each paper removes one layer of Rubik-specific structure while preserving the
...
uses the same broad philosophy of finite represented laboratories, but studies
what remains above decomposition: joint spectral collision, transport,
accessibility, and deformation geometry.
